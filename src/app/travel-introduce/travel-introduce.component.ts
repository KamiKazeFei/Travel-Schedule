...
export class TravelIntroduceComponent {
  ...
  /** 旅行計畫 */
  travelSchedule: TravelDayIntroduce[] = [
    // 第一天
    {
      title: '【Day 1】12/30(六)',
    ...
    // 第四天
    {
      ...
      memo_list: [
        ...
        '五木茶屋預約：https://www.tablecheck.com/shops/itsukichaya/reserve',
        '晚餐 予約不可'
      ],
    ...
    // 第五天
    {
      ...
      schedule_list: [
        ...
        {
          time: '19:00 ~ ',
          pic_src: 'assets/心齋橋商店街.jpg',
          description: '心齋橋商店街、道頓堀',
          map_location: 'https://www.google.com.tw/maps/place/%E5%BF%83%E9%BD%8B%E6%A9%8B%E7%AD%8B%E5%95%86%E5%BA%97%E8%A1%97/@34.6709513,135.498707,17z/data=!3m2!4b1!5s0x6000e71157701a53:0x537058362fd10a11!4m6!3m5!1s0x6000e713fc37b373:0x625cc4399599c323!8m2!3d34.6709469!4d135.5012819!16s%2Fg%2F1221h6_6?hl=zh-TW&authuser=0&entry=ttu'
        }
      ],
